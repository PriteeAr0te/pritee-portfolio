                ...
                <div className="flex flex-wrap gap-2">
                    {skills.map((skill) => (
                        <motion.div key={skill.name} className="group relative duration-300">
                            <div
                                className="flex items-center gap-2 text-lg px-4 py-2 dark:bg-gray-800/70 rounded-full border border-gray-700 hover:border-emerald-500/50 transition-all duration-300 shadow-md hover:shadow-emerald-500/10"
