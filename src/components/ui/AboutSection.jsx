            ...
            <div className='max-w-7xl mx-auto'>
                <div className='text-center mb-12'>
                    <motion.h2
                        ...
                        id='about-title'
                        className='text-3xl md:text-4xl font-bold text-slate-900 dark:text-white'>About <span className='text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-blue-500'>Me</span></motion.h2>
