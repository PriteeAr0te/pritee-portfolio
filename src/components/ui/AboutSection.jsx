...
const AboutSection = () => {
    return (
        <section id='about' className='py-20 overflow-x-hidden relative'>
            ...
            <div className='max-w-7xl mx-auto'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 items-stretch'>
                    <div className='h-full'>
                        <div className='bg-emerald-50 dark:bg-gray-800/40 backdrop-blur-sm rounded-2xl p-3 sm:p-6 border border-gray-700/50 hover:border-emerald-500/30 transition-all duration-300 shadow-xl h-full relative overflow-hidden'>
                            <h3 className='text-2xl font-semibold text-gray-900 dark:text-white mb-6 relative text-left'>My Journey</h3>
                            <div className='space-y-4 relative'>
                                <p className='text-gray-800 dark:text-gray-300 leading-relaxed text-left'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque illo eveniet impedit reprehenderit aliquam quam voluptas porro possimus consectetur quis soluta cupiditate perferendis harum est, culpa, assumenda vel exercitationem nesciunt?</p>
                                <p className='text-gray-800 dark:text-gray-300 leading-relaxed text-left'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque illo eveniet impedit reprehenderit aliquam quam voluptas porro possimus consectetur quis soluta cupiditate perferendis harum est, culpa, assumenda vel exercitationem nesciunt?</p>
                                <p className='text-gray-800 dark:text-gray-300 leading-relaxed text-left'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque illo eveniet impedit reprehenderit aliquam quam voluptas porro possimus consectetur quis soluta cupiditate perferendis harum est, culpa, assumenda vel exercitationem nesciunt?</p>
                            </div>
