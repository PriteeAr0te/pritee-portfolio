        ...
        <section className='py-20 overflow-x-hidden relative text-center'>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-4xl font-bold text-white">Connect <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-blue-500">With Me</span></h2>
                    <div className="mt-4 h-1 w-20 bg-gradient-to-r from-emerald-400 to-blue-500 mx-auto rounded-full"></div>
                    <p className="mt-6 text-gray-300 max-w-2xl mx-auto">Feel free to connect with me on these platforms to discuss tech, share ideas, or just say hello!</p>
                </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="relative flex flex-col items-center text-center p-6 h-full z-10">
                                    ...
                                    <span className="text-l font-medium text-white mb-1">GitHub</span>
                                </div>
                            </a>
                        </div>
                        <div
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="relative flex flex-col items-center text-center p-6 h-full z-10">
                                    ...
                                    <span className="text-l font-medium text-white mb-1">LinkedIn</span>
                                </div>
                            </a>
                        </div>
                        <div
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="relative flex flex-col items-center text-center p-6 h-full z-10">
                                    ...
                                    <span className="text-l font-medium text-white mb-1">Twitter</span>
                                </div>
                            </a>
                        </div>
                    </div>
